      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 max-w-3xl mx-auto">
            The most powerful visual development platform. Create, collaborate,
            and deploy production-ready websites with our drag-and-drop editor,
            ...
            {[
              {
                ...
                description:
                  "Intuitive visual builder with real-time preview and responsive design tools.",
              },
              {
                icon: <Code className="w-8 h-8" />,
                title: "Code Integration",
                description:
                  "Seamlessly switch between visual and code editing with 2-way sync.",
              },
              {
              ...
              },
              {
                ...
                title: "Design System",
                description:
                  "Built-in component library with customizable design tokens.",
              },
              {
                icon: <Globe className="w-8 h-8" />,
                title: "Global Deployment",
                description:
                  "Deploy to CDN edge locations worldwide for lightning-fast loading.",
              },
              {
                icon: <GitBranch className="w-8 h-8" />,
                title: "Version Control",
                description:
                  "Complete version history with branching and merge capabilities.",
              },
              {
                icon: <Smartphone className="w-8 h-8" />,
                title: "Mobile-First",
                description:
                  "Responsive design tools with mobile, tablet, and desktop previews.",
              },
              {
                icon: <Zap className="w-8 h-8" />,
                title: "Performance",
                description:
                  "Optimized code generation for maximum speed and SEO performance.",
              },
              {
                icon: <Eye className="w-8 h-8" />,
                title: "Live Preview",
                description:
                  "See changes instantly with hot reload and real-time rendering.",
              },
            ].map((feature, index) => (
              <Card
                key={index}
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              ...
              <Card
                key={index}
                className={`${plan.popular ? "ring-2 ring-purple-600 bg-white dark:bg-gray-800" : "bg-white dark:bg-gray-800"} relative`}
              >
                {plan.popular && (
